...
🎓 Currently preparing to join the **AIDA Lab, Department of Industrial Management Engineering, Korea University** for a Master's program.

🔬 Research Interests: Multimodal Learning, Domain Transfer, Continual Learning
...
✔️ Industrial Systems Engineering IAI Lab @Dongguk.Univ (2023.04 ~ 2024.07)
...
- **SK-RD4AD: Skip-Connected Reverse Distillation for Robust One-Class Anomaly Detection** — CVPR 2025 Workshop
- **Enhancing KB-VQA through Multilayer Co-Attention and Question-Aware Prompt** — IEIE 2024 Autumn (Poster)
- **Risk Factor Detection and Path Prediction-Based Methodology for Industrial Site Hazard Forecasting** — KORMS·KIIE 2024 Spring (Poster)
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Pytorch-3766AB?style=flat-square&logo=Pytorch&logoColor=white"/>
